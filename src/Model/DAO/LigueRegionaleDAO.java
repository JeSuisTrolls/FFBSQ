...
import Model.Classes.Metiers.LigueRegionale;
...
public class LigueRegionaleDAO extends AbstractCRUD
        implements InterfOperationsAdmin {
    public LigueRegionaleDAO(ConnectionDB conn_db, String requete, ArrayList<String> listValeurs, ArrayList<String> listTypes) {
        super(conn_db, requete, listValeurs, listTypes);
    }

    public LigueRegionaleDAO(ConnectionDB conn_db) {
        super(conn_db);
    }
    ...
    public Resultat select(Object obj) {
        if(obj instanceof LigueRegionale) {

            String requete = "select * from LIGUE_REGIONALE";
