...
import Model.Classes.Metiers.Discipline;
...
public class DisciplineDAO extends AbstractCRUD
        implements InterfOperationsAdmin {
    public DisciplineDAO(ConnectionDB conn_db, String requete, ArrayList<String> listValeurs, ArrayList<String> listTypes) {
        super(conn_db, requete, listValeurs, listTypes);
    }

    public DisciplineDAO(ConnectionDB conn_db) {
        super(conn_db);
    }
